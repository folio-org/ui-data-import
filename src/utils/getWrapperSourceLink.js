...
export const getWrapperSourceLink = (key, resourceLimit = PER_REQUEST_LIMIT) => {
  const WRAPPER_SOURCE_LINKS = {
    PREFIXES: `/orders/configurations/prefixes?limit=${resourceLimit}&query=${FIND_ALL_CQL} sortby name`,
    SUFFIXES: `/orders/configurations/suffixes?limit=${resourceLimit}&query=${FIND_ALL_CQL} sortby name`,
