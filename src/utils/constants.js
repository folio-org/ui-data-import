...
export const FILE_STATUSES = {
  NEW: 'NEW',
  UPLOADING: 'UPLOADING',
  UPLOADING_CANCELLABLE: 'UPLOADING-CANCELLABLE',
  UPLOADED: 'UPLOADED',
  COMMITTED: 'COMMITTED',
  ERROR: 'ERROR',
...
export const DEFAULT_DELETE_MARC_AUTH_JOB_ID = '1a338fcd-3efc-4a03-b007-394eeb0d5fb9';
export const DEFAULT_DELETE_MARC_AUTH_MATCH_ID = '4be5d1d2-1f5a-42ff-a9bd-fc90609d94b6';
export const DEFAULT_DELETE_MARC_AUTH_ACTION_ID = 'fabd9a3e-33c3-49b7-864d-c5af830d9990';
export const DEFAULT_DELETE_MARC_AUTH_MAPPING_ID = 'ff029a0a-82ff-486d-b2b1-7a4ef4cb7988';
...
export const DEFAULT_PROFILE_IDS = [
  ...
  DEFAULT_DELETE_MARC_AUTH_JOB_ID,
  DEFAULT_DELETE_MARC_AUTH_ACTION_ID,
  DEFAULT_DELETE_MARC_AUTH_MAPPING_ID,
];
...
export const PROFILE_IDS_WITH_DISABLED_DELETE_BUTTON = [
  DEFAULT_DELETE_MARC_AUTH_MATCH_ID,
];
