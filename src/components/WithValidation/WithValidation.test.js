...
const TestComponent = (props) => {
    ...
    return (<div>
        ...
        <input data-testid="name" type="text" id="name" name="name" onChange={props.validate("hello")} value="Hello" />
        <label for="age">Age:</label>
        <input data-testid="age" type="text" id="age" name="age" onChange={handleChange} value={data} />
        </div>);
};
