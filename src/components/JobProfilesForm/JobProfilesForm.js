...
export const JobProfilesForm = stripesForm({
  ...
  const paneTitle = <FormattedMessage id="ui-data-import.settings.jobProfiles.newJob" />;
  const headLine = <FormattedMessage id="ui-data-import.settings.jobProfiles.newJob" />;
