  ...
  static manifest = Object.freeze({
    ...
    jobsUsingThisProfile: {
      ...
      path: createUrl('metadata-provider/jobExecutions', {
        // query: '(matchProfileInfo.id==":{id}") sortBy completedDate/sort.descending',
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <AccordionSet>
          <Accordion label={<FormattedMessage id="ui-data-import.settings.matchProfiles.summary" />}>
            <this.connectedViewMetaData
              metadata={record.metadata}
              systemId={SYSTEM_USER_ID}
              systemUser={SYSTEM_USER_NAME}
            />
            <KeyValue label={<FormattedMessage id="ui-data-import.settings.matchProfiles.acceptedDataType" />}>
          ...
          <Accordion label={<FormattedMessage id="ui-data-import.settings.matchProfiles.overview" />}>
            <div style={{ height: 60 }}>{/* will be implemented in UIDATIMP-152 */}</div>
          </Accordion>
          <Accordion label={<FormattedMessage id="ui-data-import.settings.matchProfiles.jobsUsingThisProfile" />}>
