...
describe('Holdings "Administrative data" edit component', () => {
  beforeAll(() => {
  ...
  describe('"Former holdings" field', () => {
    it('User can add former holdings identifier', async () => {
      ...
      const addButton = await findByRole('button', { name: /add former holdings identifier/i });
      fireEvent.click(addButton);
